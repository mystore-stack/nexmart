...
export const metadata = generateSEOMetadata({
  title: "Mega Sale",
  description: "Our biggest sale of the year! Massive discounts across all categories. Shop the mega sale and save up to 70%.",
  keywords: ["mega sale", "biggest sale", "massive discounts", "yearly sale"],
});

async function getMegaSaleProducts() {
...
export default async function MegaSalePage({
  searchParams,
}: {
  ...
  const { products, totalCount } = await getMegaSaleProducts();
  ...
  const filterGroups: FilterGroup[] = [
    {
      ...
      options: [
        ...
        { id: "accessories", label: "Accessories", count: 110 },
        { id: "home", label: "Home & Living", count: 85 },
        { id: "beauty", label: "Beauty", count: 65 },
      ],
      type: "checkbox",
    },
    {
  ...
  return (
    <div className="min-h-screen">
      <PageHero
        ...
        description="Massive discounts across all categories. Save up to 70% on premium products!"
      ...
      <CTABanner
        ...
        description="The mega sale won't last forever. Shop now and save big on your favorite products."
        buttonText="Shop Mega Sale"
        buttonLink="/mega-sale"
        variant="secondary"
      />
