...
export default function Page() {
  ...
  useEffect(() => {
    ...
    console.log("Sentry example page loaded (disabled)");
    async function checkConnectivity() {
      // const result = await Sentry.diagnoseSdkConnectivity();
      // setIsConnected(result !== "sentry-unreachable");
      setIsConnected(false); // Disabled
    }
    checkConnectivity();
  }, []);
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            rel="noopener"
            href="https://store-n0.sentry.io/issues/?project=4511439303540816"
          >
            Issues Page
          </a>
        ...
        <button
          ...
          onClick={async () => {
            ...
            console.log("User clicked the button, throwing a sample error (disabled)");
