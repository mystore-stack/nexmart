...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Check for existing order BEFORE acquiring lock to avoid unnecessary lock waits
    ...
    // If Redis is unavailable, proceed without locking (rely on database uniqueness)
    let order: any = await withLock(
