"use client";
// src/app/admin/cms/sponsored/page.tsx — Sponsored Products Management with Product Selector
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-foreground flex items-center gap-2">
              <Award className="w-6 h-6 text-sky-600" /> Gestion des Produits Sponsorisés
            </h1>
            <p className="text-xs text-muted-foreground">Sélectionnez les produits à afficher dans la section Produits Sponsorisés.</p>
          </div>
        </div>
