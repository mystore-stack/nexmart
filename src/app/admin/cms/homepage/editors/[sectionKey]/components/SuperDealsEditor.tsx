...
export function SuperDealsEditor({ section, parsedConfig }: { section: any; parsedConfig: any }) {
    ...
    <div className="space-y-8">
      <div>
        <div className="flex items-center justify-between">
          <h3 className="text-xl font-semibold">Super Deals Configuration</h3>
          <button
            onClick={handleSave}
            disabled={isPending}
        ...
        <p className="text-sm text-muted-foreground mt-1 mb-4">
          Configure the texts and products for the Super Deals section.
        </p>
