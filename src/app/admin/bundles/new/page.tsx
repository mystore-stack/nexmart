    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-foreground">Create New Bundle</h1>
            <p className="text-slate-600 mt-1">Create a product bundle with special pricing</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., Moroccan Beauty Essentials"
          ...
          {/* Product Selection */}
          <div className="bg-white rounded-lg border border-border p-6 shadow-sm">
            <h2 className="text-lg font-bold text-foreground mb-4">Add Products</h2>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-2">
                  Select Products
          ...
          {selectedProductsData.length > 0 && (
            <div className="bg-white rounded-lg border border-border shadow-sm overflow-hidden">
              ...
              <div className="p-4">
                ...
                <h4 className="font-semibold text-foreground mb-2">{name || 'Untitled Bundle'}</h4>
