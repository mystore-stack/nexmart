        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              ...
              <Select value={filters.type || "all"} onValueChange={(value: string) => setFilters({ ...filters, type: value === "all" ? "" : value, page: 1 })}>
                <SelectTrigger>
            ...
            <div>
              ...
              <Select value={filters.status || "all"} onValueChange={(value: string) => setFilters({ ...filters, status: value === "all" ? "" : value, page: 1 })}>
                <SelectTrigger>
