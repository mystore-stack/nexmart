...
const heroBannerSchema = z.object({
  ...
  desktopImageUrl: z.string().url("Invalid desktop image URL").optional().or(z.literal("")),
  mobileImageUrl: z.string().url("Invalid mobile image URL").optional().nullable().or(z.literal("")),
  videoUrl: z.string().url("Invalid video URL").optional().or(z.literal("")),
  primaryButtonText: z.string().optional(),
  primaryButtonLink: z.string().url("Invalid primary button link").optional().or(z.literal("")),
  secondaryButtonText: z.string().optional(),
  secondaryButtonLink: z.string().url("Invalid secondary button link").optional().or(z.literal("")),
