"use client";
// src/app/collections/flash-deals/page.tsx
import React, { useState, useEffect } from "react";
import { Zap, ShoppingBag, Heart, Star } from "lucide-react";
...
export default function FlashDealsCollectionPage() {
  ...
  return (
    <div className="min-h-screen bg-surface/30">
      {/* Header */}
      <div className="bg-gradient-to-r from-amber-500 to-orange-600 text-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/20 backdrop-blur-sm">
              <Zap className="h-6 w-6 fill-white-white" />
            </div>
            <h1 className="text-4xl font-bold tracking-tight">Ventes Flash</h1>
          </div>
          <p className="text-white/90 text-lg">Offres exceptionnelles à durée limitée</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <h2 className="text-xl font-bold text-foreground mb-2">Aucune vente flash disponible</h2>
            <p className="text-muted-foreground">Revenez plus tard pour découvrir nos offres exceptionnelles</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
