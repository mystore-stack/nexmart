                ...
                <div className="grid grid-cols-2 gap-1.5 my-1">
                  <div className="bg-white p-2 rounded-xl border text-[10px]">
                    <div className="h-14 relative bg-surface rounded-lg mb-1">
                      <Image src="/images/promo_flash_sale.jpg" alt="AirPods" fill className="object-contain" />
                    </div>
                  ...
                  <div className="bg-white p-2 rounded-xl border text-[10px]">
                    <div className="h-14 relative bg-surface rounded-lg mb-1">
                      <Image src="/images/promo_bundle.jpg" alt="Watch" fill className="object-contain" />
                    </div>
