        ...
        {BANNERS.map((b, i) => (
          ...
          >
            <Link href={b.href} className="group block">
              <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${b.gradient} p-7 transition-all duration-400 hover:-translate-y-1.5 hover:shadow-2xl overflow-hidden`}
