"use client";
// src/components/home/DesktopHero.tsx - Desktop hero with rich layout
...
export function DesktopHero() {
  ...
  return (
    <div
      className="relative min-h-[560px] overflow-hidden rounded-[2rem] border border-orange-200/60 bg-slate-950 shadow-[0_24px_80px_rgba(15,23,42,0.15)]"
      onMouseEnter={() => setPaused(true)}
      onMouseLeave={() => setPaused(false)}
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(249,115,22,0.18),_transparent_40%),linear-gradient(90deg,_rgba(15,23,42,0.95),_rgba(15,23,42,0.85))]" />
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <Image src={slide.image} alt="" fill className="object-cover opacity-35" priority sizes="100vw" />
      ...
      <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-orange-400/70 to-transparent" />

      {/* Main Content Grid */}
      <div className="relative z-10 grid min-h-[560px] items-center gap-8 px-5 py-8 sm:px-8 lg:grid-cols-[1.1fr_0.9fr] lg:px-12 lg:py-10">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <motion.div
              ...
              className="mb-5 inline-flex items-center gap-2.5 rounded-full border border-orange-400/30 bg-orange-500/10 px-4 py-2 backdrop-blur"
            >
            ...
            {/* Headline */}
            <h1 className="font-display text-4xl font-semibold leading-[1.02] text-white sm:text-5xl lg:text-6xl">
            ...
            {/* Gold divider */}
            <div className="my-6 h-px w-16 bg-gradient-to-r from-orange-400 to-transparent" />
        ...
        <div className="hidden lg:flex justify-end">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Main image card */}
              <div className="relative overflow-hidden rounded-[1.75rem] border border-orange-400/20 bg-white/8 shadow-2xl backdrop-blur-xl"
                style={{ boxShadow: "0 24px 70px rgba(0,0,0,0.35), 0 0 0 1px rgba(249,115,22,0.17)" }}>

                {/* Moroccan arch top decoration */}
                <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-transparent via-orange-400/70 to-transparent" />
                ...
                <motion.div
                  ...
                  className="absolute top-4 left-4 rounded-2xl border border-orange-400/30 bg-black/50 px-4 py-3 backdrop-blur-xl"
                >
                  <p className="text-xs font-bold text-orange-300/80 uppercase tracking-[0.24em]">Confiance</p>
