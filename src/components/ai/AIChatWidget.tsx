  ...
  return (
    <>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-[120px] sm:bottom-24 right-4 z-50 flex flex-col overflow-hidden rounded-2xl border border-gold-200/40 dark:border-gold-800/20"
            style={{
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-[85px] sm:bottom-6 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-brand-700 text-white shadow-[0_8px_32px_rgba(15,118,110,0.5)] hover:bg-brand-600 transition-colors"
