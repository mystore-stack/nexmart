...
export function SectionHeader({
  ...
  return (
    <div className={`mb-10 flex flex-col gap-6 ${centered ? "items-center text-center" : "lg:flex-row lg:items-end lg:justify-between"}`}>
      <div className={centered ? "max-w-2xl" : "max-w-3xl"}>
        ...
        {description && (
          <p className="mt-4 max-w-2xl text-base leading-7 text-[hsl(var(--ai-muted))]">{description}</p>
        )}
      </div>
