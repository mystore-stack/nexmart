// src/app/layout.tsx — NexMart Enterprise Root Layout
...
export const metadata: Metadata = {
  title: {
    default: "NexMart — السوق الإلكتروني المغربي الأول",
    template: "%s | NexMart Maroc",
  },
  description: "NexMart — La marketplace e-commerce premium du Maroc. Millions de produits. Livraison rapide. Paiement sécurisé.",
  keywords: ["e-commerce maroc", "marketplace maroc", "acheter en ligne maroc", "vendre en ligne maroc", "livraison maroc", "artisanat marocain"],
  authors: [{ name: "NexMart Maroc" }],
  creator: "NexMart",
  publisher: "NexMart SARL",
  metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL || "https://nexmart.ma"),
  alternates: { canonical: "/", languages: { "fr-MA": "/fr", "ar-MA": "/ar" } },
  openGraph: {
    type: "website",
    locale: "fr_MA",
  ...
  twitter: { card: "summary_large_image", title: "NexMart Maroc 🇲🇦", description: "La marketplace premium du Maroc", images: ["/og-image.jpg"], creator: "@nexmart_ma" },
