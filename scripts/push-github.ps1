# Publie le code sur https://github.com/mystore-stack/nexmart-ma1
...
Write-Host '     git remote set-url origin https://mystore-stack:<VOTRE_TOKEN>@github.com/mystore-stack/nexmart-ma1.git' -ForegroundColor White
...
if ($LASTEXITCODE -eq 0) {
  ...
  Write-Host "Ou connectez le repo dans Vercel : https://vercel.com/you-store-s-projects/nexmart-ma/settings/git" -ForegroundColor Cyan
}
