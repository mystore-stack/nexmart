          ...
          <aside className="lg:col-span-1 space-y-4">
            ...
            <div className="bg-card border border-border rounded-2xl p-5 text-center">
              <div className="relative w-20 h-20 mx-auto mb-3">
                <div className="w-20 h-20 rounded-full bg-foreground flex items-center justify-center text-background text-2xl font-bold overflow-hidden">
                  {user?.avatar ? (
                ...
                <button className="absolute bottom-0 right-0 w-7 h-7 rounded-full bg-brand-500 flex items-center justify-center text-white shadow-md hover:bg-brand-600 transition-colors">
